...
(function () {
  ...
  MCI.defaultSettings = function () {
    ...
    return {
      ...
      quickActions: t.defaultQuickActions || ["Walk","Meditate","Call a friend","Early night","Breathing","Journal","Stretch","Go outside"],
      components: {
  ...
  MCI.loadSettings = function () {
    ...
    /* migrate the retired "logo3" key → the Keep-The-Wolves-Away "wolf" logo */
    if (out.logo === "logo3") out.logo = "wolf";
    return out;
  };
